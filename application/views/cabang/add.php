        ...
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <input value="<?= set_value('alamat_cabang'); ?>" name="alamat_cabang" id="alamat_cabang" type="text" class="form-control" placeholder="Alamat Cabang...">
                    ...
                    <div class="col-md-9">
                        <select type="text" class="form-control" id="id_user" name="id_user" title="Pilih Nama Barang" required>
                            <?php foreach ($user_admin as $ua) : ?>
                                ...
                                <option value="<?= $ua['id_user']; ?>"><?= $ua['nama']; ?></option>
                            <?php endforeach; ?>
                        </select>
                        <?= form_error('alamat_cabang', '<small class="text-danger">', '</small>'); ?>
                    </div>
