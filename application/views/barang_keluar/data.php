            ...
            <tbody>
                ...
                if ($barangkeluar) :
                    foreach ($barangkeluar as $bk) :
                        $popup_detail = 'data-toggle="modal" data-target="#modal_show_bj" data-id="' . $bk['id_barang_keluar'] . '" class="data-bk" data-backdrop="static" data-keyboard="false" style="cursor:pointer;"';
                ?>
                        <tr>
                            <td <?= $popup_detail ?>><?= $no++; ?></td>
                            <td <?= $popup_detail ?>><?= $bk['id_barang_keluar']; ?></td>
                            <td <?= $popup_detail ?>><?= $bk['nama_cabang']; ?></td>
                            <td <?= $popup_detail ?>><?= $bk['tanggal_keluar']; ?></td>
                            <td <?= $popup_detail ?>><?= $bk['nama_customer']; ?></td>
