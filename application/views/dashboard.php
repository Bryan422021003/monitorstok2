...
<div class="row">
    ...
    <div class="col-md-4">
        <div class="card shadow mb-4">
            ...
            <div class="table-responsive">
                <table class="table mb-0 table-sm table-hover text-center">
                    <thead>
                        <tr>
                            <th>Tanggal</th>
                            <th>ID Transaksi</th>
                    ...
                    <tbody>
                        <?php foreach ($transaksi['barang_masuk'] as $tbm) :
                            $popup_detail = 'data-toggle="modal" data-target="#modal_show_bj" data-id="' . $tbm['id_barang_masuk'] . '" class="data-bj" data-backdrop="static" data-keyboard="false" style="cursor:pointer;"';
                        ?>
                            <tr>
                                <td <?= $popup_detail ?>><strong><?= $tbm['tanggal_masuk']; ?></strong></td>
                                <td <?= $popup_detail ?>><?= $tbm['id_barang_masuk']; ?></td>
                                <td <?= $popup_detail ?>><?= $tbm['nama_supplier']; ?></td>
                ...
                <table class="table mb-0 table-sm table-hover text-center">
                    ...
                    <tbody>
                        <?php foreach ($transaksi['barang_keluar'] as $tbk) :
                            $popup_detail = 'data-toggle="modal" data-target="#modal_show_bj" data-id="' . $tbk['id_barang_keluar'] . '" class="data-bk" data-backdrop="static" data-keyboard="false" style="cursor:pointer;"';
                        ?>
                            <tr>
                                <td <?= $popup_detail ?>><strong><?= $tbk['tanggal_keluar']; ?></strong></td>
                                <td <?= $popup_detail ?>><?= $tbk['id_barang_keluar']; ?></td>
