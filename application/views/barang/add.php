    ...
    <div class="col-md-8">
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="batas">Batas Minimun Stok</label>
                    <div class="col-md-9">
                        <input value="<?= set_value('batas',0); ?>" name="batas" id="batas" type="number" class="form-control" placeholder="Batas Minmun Stok...">
                        <?= form_error('batas', '<small class="text-danger">', '</small>'); ?>
                    </div>
                </div>
                <div class="row form-group">
